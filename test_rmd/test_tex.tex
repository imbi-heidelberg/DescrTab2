...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{source}\NormalTok{(}\StringTok{"../R/descr.R"}\NormalTok{)}
\KeywordTok{options}\NormalTok{(}\DataTypeTok{DescrTabFormat =} \StringTok{"tex"}\NormalTok{)}
\KeywordTok{capture.output}\NormalTok{(}\KeywordTok{descr}\NormalTok{(iris)) }\OperatorTok{%>%}\StringTok{ }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{raw_latex}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
