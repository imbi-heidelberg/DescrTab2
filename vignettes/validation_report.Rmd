...
descr(dat, "group", test_options = list(paired=T, indices=c(1:1600, 1:1600)))
descr(dat, "group", test_options = list(paired=T, exact=T, indices=c(1:1600, 1:1600)))
...
mcnemar.test(dat$x, dat$y, correct = F)
